 ...
 * to write, read and modify data-stores specific to various other Neo NSH modules
 */
public class RegistryHandlerModule extends eu.neonsh.registryhandler.impl.AbstractRegistryHandlerModule {
    ...
    public RegistryHandlerModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,
                                 org.opendaylight.controller.config.api.DependencyResolver dependencyResolver, eu.neonsh.registryhandler.impl.RegistryHandlerModule oldModule, java.lang.AutoCloseable oldInstance) {
